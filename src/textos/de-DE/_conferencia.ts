...
export const conferidos = [_alertas, _alimentacao, _aviso, _avisos, _cadastro, _ciclo, _companion, _comum, _confirmacoes, _conquistas, _cuidado, _descobertas, _equilibrio, _escalas, _etapa, _exames, _fontes, _formas, _home, _idioma, _leituras, _medidas, _resumo, _tempo, _tratamento];
