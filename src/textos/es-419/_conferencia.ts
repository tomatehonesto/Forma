/* ============================================================
   A CONFERÊNCIA DE FORMA — es-419 tem de ter a assinatura do português
...
import type { conta as contaPt } from '../pt-BR/conta';
...
import type { rede as redePt } from '../pt-BR/rede';
...
const _conta: typeof contaPt = conta;
...
const _rede: typeof redePt = rede;
...
export const conferidos = [_ajuda, _alertas, _alimentacao, _assinatura, _aviso, _avisos, _cadastro, _ciclo, _companion, _comum, _confirmacoes, _conquistas, _conta, _cruzamentos, _cuidado, _descobertas, _equilibrio, _escalas, _etapa, _exames, _fontes, _formas, _home, _idioma, _leituras, _marcadores, _medidas, _metas, _perfil, _rede, _resumo, _rotina, _semente, _tempo, _tratamento];
