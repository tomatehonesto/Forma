...
export const conferidos = [_alertas, _aviso, _avisos, _ciclo, _companion, _comum, _confirmacoes, _descobertas, _equilibrio, _escalas, _etapa, _exames, _fontes, _formas, _idioma, _medidas, _resumo, _tempo];
