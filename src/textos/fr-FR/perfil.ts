...
export const perfil = {
  ...
  aparenciaSub: (paleta: string, escuro: boolean) =>
    `${paleta}, en mode ${escuro ? 'sombre' : 'clair'} · choisissez la couleur de l’application`,
  ...
  reportarSub: 'Racontez ce qui s’est passé — nous joignons la version de l’application',
