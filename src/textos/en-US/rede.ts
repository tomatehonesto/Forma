...
export const rede = {
  ...
  apresentacao: {
    ...
    passos: [
      { titulo: 'Find a clinic', texto: 'Choose by specialty, insurance and how far it is from you.' },
      { titulo: 'Book your first appointment', texto: 'Contact the clinic directly on WhatsApp, by phone or through its website.\nThat contact doesn’t go through Morphi.' },
      ...
      { titulo: 'And the team follows along', texto: 'Everything you’ve already logged stays here. The link with the clinic doesn’t erase anything.' },
    ],
